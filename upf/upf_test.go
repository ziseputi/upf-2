...
func httpSyn() []byte {
	httpsyndata := []byte{0x45, 0x00, 0x00, 0x40, 0x00, 0x00, 0x40, 0x00, 0x40, 0x06, 0x51, 0xe6, 0x0a, 0x06, 0x00, 0x04,
		0x0a, 0x0a, 0xd4, 0xbe,
...
func httpAck() []byte {
	httpackdata := []byte{0x45, 0x00, 0x00, 0x34, 0x00, 0x00, 0x40, 0x00, 0x40, 0x06, 0x51, 0xf2, 0x0a, 0x06, 0x00, 0x04,
		0x0a, 0x0a, 0xd4, 0xbe,
...
func httpGet() []byte {
	getHttpData := []byte{0x45, 0x00, 0x02, 0x04, 0x00, 0x00, 0x40, 0x00, 0x40, 0x06, 0x50, 0x22, 0x0a, 0x06, 0x00, 0x04,
		0x0a, 0x0a, 0xd4, 0xbe,
